...
public class ControladorMaestro {
    ...
    private static final String RUTA_VISTAS = "cl/gz/arbitrium/fxml/";
    ...
    public static FXMLLoader getFXMLLoader(String ruteFXML){
        return new FXMLLoader(new ControladorMaestro().getClass().getClassLoader().getResource(RUTA_VISTAS + ruteFXML + ".fxml"));
    }
